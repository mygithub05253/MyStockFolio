...
/**
 * OAuth2 로그인 후 추가 정보 입력 페이지
 * 닉네임이 없는 신규 OAuth2 사용자가 닉네임을 입력하는 페이지
 */
const OAuth2SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { userId, email: userEmail, nickname: userNickname, accessToken } = response.data;
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            {getProviderName(provider)} 계정으로 로그인하셨습니다.
            <br />
            닉네임을 입력해주세요.
          </p>
        </div>
